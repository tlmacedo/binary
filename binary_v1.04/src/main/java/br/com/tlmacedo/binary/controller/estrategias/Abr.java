...
//                                    proposal = null;
    ...
    @Override
    public void gerarNovosContratos(int t_id, int s_id, BigDecimal payout, BigDecimal askPrice) {

        try {

            for (int contractType = 0; contractType < 2; contractType++) {
                for (int lastWin = 0; lastWin < 2; lastWin++) {
                    getVlrStkContrato()[t_id][s_id].setValue(lastWin == 0
...
//            BigDecimal myVlrLossAcumulado = getVlrLossAcumulado()[t_id][s_id].getValue();
////            myVlrLossAcumulado = (myVlrLossAcumulado.add(payout));
//            if ((myVlrLossAcumulado.add(payout)).compareTo(BigDecimal.ZERO) < 0) {
//                myVlrLossAcumulado = (myVlrLossAcumulado.add(payout)).negate();
//                if ((myVlrLossAcumulado.add(payout)).compareTo(getVlrStkPadrao()[t_id].getValue()) >= 0) {
//                    getVlrStkContrato()[t_id][s_id].setValue(
//                            (myVlrLossAcumulado.add(payout)).multiply(myPorcMg));
//                } else {
//                    getVlrStkContrato()[t_id][s_id].setValue(
...
////            myVlrLossAcumulado = (myVlrLossAcumulado.add(payout)).add(askPrice.negate());
//            getVlrStkContrato()[t_id][s_id].setValue(
//                    (myVlrLossAcumulado.add(payout)).multiply(myPorcMg));
//            for (int contractType = 0; contractType < 2; contractType++) {
